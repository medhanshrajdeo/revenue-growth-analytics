...
rgm-project/
├── data/
│   ├── raw/                        # Original Dunnhumby CSVs (not committed)
│   ├── processed/                  # Cleaned parquets (11 tables)
│   └── powerbi_exports/            # 7 CSVs ready for Power BI Desktop
├── notebooks/
...
│   └── 05_kpi_export.ipynb
├── outputs/
│   ├── charts/                     # PNG charts (generated by _make_charts.py)
...
# Place Dunnhumby CSVs in data/raw/
